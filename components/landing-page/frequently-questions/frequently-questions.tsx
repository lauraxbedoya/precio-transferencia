      ...
      <div className={styles.wrapper}>
        <div className={styles.sectionIntro}>
          ...
          <PTText size='sm' weight='400' className={`${styles.textDarkGrey} ${styles.noMargin}`}>
            ...
            SI TIENES OTRAS DUDAS, NO DUDES EN PREGUNTARNOS POR EL CHAT EN VIVO.
          </PTText>
        </div>
        ...
        <div className={styles.miniFaq}>
          <div className={styles.faqTestimonial}>
            ...
            <PTButton
              ...
              style={{ backgroundColor: 'var(--primary-color)', color: 'var(--ternary-color)' }}
